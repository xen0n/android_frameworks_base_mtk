...
*/
    ...
    int RIL_REQUEST_GET_PHONE_RAT_FAMILY = 130;
    int RIL_REQUEST_SET_PHONE_RAT_FAMILY = 131;
    ...
    int RIL_UNSOL_SET_PHONE_RAT_FAMILY_COMPLETE = 1042;
...
//MTK_TC1_FEATURE for LGE CSMCC_MO_CALL_MODIFIED { 
    int RIL_UNSOL_RESPONSE_MO_CALL_STATE_CHANGED = (RIL_UNSOL_VENDOR_BASE + 57);
//} 
    ...
    int RIL_REQUEST_SET_REG_RESUME = (RIL_REQUEST_C2K_BASE + 14);
    int RIL_REQUEST_ENABLE_REG_PAUSE = (RIL_REQUEST_C2K_BASE + 15);
    ...
    int RIL_UNSOL_VIA_PLMN_CHANGE_REG_PAUSE = (RIL_UNSOL_C2K_BASE + 6);
