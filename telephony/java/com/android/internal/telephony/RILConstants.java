...
*/
    ...
    // int RIL_REQUEST_SIM_GET_ATR = 133;  -- redefined by MTK
    ...
    int RIL_REQUEST_GET_COLP = (RIL_REQUEST_MTK_BASE + 0);
    int RIL_REQUEST_SET_COLP = (RIL_REQUEST_MTK_BASE + 1);
    int RIL_REQUEST_GET_COLR = (RIL_REQUEST_MTK_BASE + 2);
    int RIL_REQUEST_GET_CCM = (RIL_REQUEST_MTK_BASE + 3);
    int RIL_REQUEST_GET_ACM = (RIL_REQUEST_MTK_BASE + 4);
    int RIL_REQUEST_GET_ACMMAX = (RIL_REQUEST_MTK_BASE + 5);
    int RIL_REQUEST_GET_PPU_AND_CURRENCY = (RIL_REQUEST_MTK_BASE + 6);
    int RIL_REQUEST_SET_ACMMAX = (RIL_REQUEST_MTK_BASE + 7);
    int RIL_REQUEST_RESET_ACM = (RIL_REQUEST_MTK_BASE + 8);
    int RIL_REQUEST_SET_PPU_AND_CURRENCY = (RIL_REQUEST_MTK_BASE + 9);
    int RIL_REQUEST_MODEM_POWEROFF = (RIL_REQUEST_MTK_BASE + 10);
    int RIL_REQUEST_DUAL_SIM_MODE_SWITCH = (RIL_REQUEST_MTK_BASE + 11);
    int RIL_REQUEST_QUERY_PHB_STORAGE_INFO = (RIL_REQUEST_MTK_BASE + 12);
    int RIL_REQUEST_WRITE_PHB_ENTRY = (RIL_REQUEST_MTK_BASE + 13);
    int RIL_REQUEST_READ_PHB_ENTRY = (RIL_REQUEST_MTK_BASE + 14);
    int RIL_REQUEST_SET_GPRS_CONNECT_TYPE = (RIL_REQUEST_MTK_BASE + 15);
    int RIL_REQUEST_SET_GPRS_TRANSFER_TYPE = (RIL_REQUEST_MTK_BASE + 16);
    int RIL_REQUEST_MOBILEREVISION_AND_IMEI = (RIL_REQUEST_MTK_BASE + 17); //Add by mtk80372 for Barcode Number
    int RIL_REQUEST_QUERY_SIM_NETWORK_LOCK = (RIL_REQUEST_MTK_BASE + 18);
    int RIL_REQUEST_SET_SIM_NETWORK_LOCK = (RIL_REQUEST_MTK_BASE + 19);
    int RIL_REQUEST_SET_SCRI = (RIL_REQUEST_MTK_BASE + 20);
    int RIL_REQUEST_BTSIM_CONNECT = (RIL_REQUEST_MTK_BASE + 21);
    int RIL_REQUEST_BTSIM_DISCONNECT_OR_POWEROFF = (RIL_REQUEST_MTK_BASE + 22);
    int RIL_REQUEST_BTSIM_POWERON_OR_RESETSIM = (RIL_REQUEST_MTK_BASE + 23);
    int RIL_REQUEST_BTSIM_TRANSFERAPDU = (RIL_REQUEST_MTK_BASE + 24);
    int RIL_REQUEST_SET_NETWORK_SELECTION_MANUAL_WITH_ACT = (RIL_REQUEST_MTK_BASE + 25);
    int RIL_REQUEST_QUERY_ICCID = (RIL_REQUEST_MTK_BASE + 26);
    int RIL_REQUEST_USIM_AUTHENTICATION = (RIL_REQUEST_MTK_BASE + 27);
    int RIL_REQUEST_MODEM_POWERON = (RIL_REQUEST_MTK_BASE + 28);
    int RIL_REQUEST_GET_SMS_SIM_MEM_STATUS = (RIL_REQUEST_MTK_BASE + 29);
    /* 3G switch start */
    int RIL_REQUEST_GET_PHONE_CAPABILITY = (RIL_REQUEST_MTK_BASE + 30);
    int RIL_REQUEST_SET_PHONE_CAPABILITY = (RIL_REQUEST_MTK_BASE + 31);
    /* 3G switch end */
    /* User controlled PLMN selector with Access Technology  begin */
    int RIL_REQUEST_GET_POL_CAPABILITY = (RIL_REQUEST_MTK_BASE + 32);
    int RIL_REQUEST_GET_POL_LIST = (RIL_REQUEST_MTK_BASE + 33);
    int RIL_REQUEST_SET_POL_ENTRY = (RIL_REQUEST_MTK_BASE + 34);
    /* User controlled PLMN selector with Access Technology  end */
    /* UPB start */
    int RIL_REQUEST_QUERY_UPB_CAPABILITY = (RIL_REQUEST_MTK_BASE + 35);
    int RIL_REQUEST_EDIT_UPB_ENTRY = (RIL_REQUEST_MTK_BASE + 36);
    int RIL_REQUEST_DELETE_UPB_ENTRY = (RIL_REQUEST_MTK_BASE + 37);
    int RIL_REQUEST_READ_UPB_GAS_LIST = (RIL_REQUEST_MTK_BASE + 38);
    int RIL_REQUEST_READ_UPB_GRP = (RIL_REQUEST_MTK_BASE + 39);
    int RIL_REQUEST_WRITE_UPB_GRP = (RIL_REQUEST_MTK_BASE + 40);
    /* UPB end */
    int RIL_REQUEST_SET_SIM_RECOVERY_ON = (RIL_REQUEST_MTK_BASE + 41);
    int RIL_REQUEST_GET_SIM_RECOVERY_ON = (RIL_REQUEST_MTK_BASE + 42);
    int RIL_REQUEST_SET_TRM = (RIL_REQUEST_MTK_BASE + 43);
    int RIL_REQUEST_DETECT_SIM_MISSING = (RIL_REQUEST_MTK_BASE + 44);
    int RIL_REQUEST_GET_CALIBRATION_DATA = (RIL_REQUEST_MTK_BASE + 45);

     //For LGE APIs start
    int RIL_REQUEST_GET_PHB_STRING_LENGTH = (RIL_REQUEST_MTK_BASE + 46);
    int RIL_REQUEST_GET_PHB_MEM_STORAGE = (RIL_REQUEST_MTK_BASE + 47);
    int RIL_REQUEST_SET_PHB_MEM_STORAGE = (RIL_REQUEST_MTK_BASE + 48);
    int RIL_REQUEST_READ_PHB_ENTRY_EXT = (RIL_REQUEST_MTK_BASE + 49);
    int RIL_REQUEST_WRITE_PHB_ENTRY_EXT = (RIL_REQUEST_MTK_BASE + 50);

    // requests for read/write EFsmsp
    int RIL_REQUEST_GET_SMS_PARAMS = (RIL_REQUEST_MTK_BASE + 51);
    int RIL_REQUEST_SET_SMS_PARAMS = (RIL_REQUEST_MTK_BASE + 52);

    // NFC SEEK start
    int RIL_REQUEST_SIM_TRANSMIT_BASIC = (RIL_REQUEST_MTK_BASE + 53);
    int RIL_REQUEST_SIM_TRANSMIT_CHANNEL = (RIL_REQUEST_MTK_BASE + 54);
    int RIL_REQUEST_SIM_GET_ATR = (RIL_REQUEST_MTK_BASE + 55);
    // NFC SEEK end

    // MTK-START, SMS part, CB extension
    int RIL_REQUEST_SET_CB_CHANNEL_CONFIG_INFO = (RIL_REQUEST_MTK_BASE + 56);
    int RIL_REQUEST_SET_CB_LANGUAGE_CONFIG_INFO = (RIL_REQUEST_MTK_BASE + 57);
    int RIL_REQUEST_GET_CB_CONFIG_INFO = (RIL_REQUEST_MTK_BASE + 58);
    int RIL_REQUEST_SET_ALL_CB_LANGUAGE_ON = (RIL_REQUEST_MTK_BASE + 59);
    // MTK-END, SMS part, CB extension

    int RIL_REQUEST_SET_ETWS = (RIL_REQUEST_MTK_BASE + 60);

    // [New R8 modem FD]
    int RIL_REQUEST_SET_FD_MODE = (RIL_REQUEST_MTK_BASE + 61);

    // detach PS service request
    int RIL_REQUEST_DETACH_PS = (RIL_REQUEST_MTK_BASE + 62);

    int RIL_REQUEST_SIM_OPEN_CHANNEL_WITH_SW = (RIL_REQUEST_MTK_BASE + 63); // NFC SEEK

    /// M: [C2K][IR] Support SVLTE IR feature. @{
    int RIL_REQUEST_SET_REG_SUSPEND_ENABLED  = (RIL_REQUEST_MTK_BASE + 64);
    int RIL_REQUEST_RESUME_REGISTRATION  = (RIL_REQUEST_MTK_BASE + 65);
    /// M: [C2K][IR] Support SVLTE IR feature. @}
    int RIL_REQUEST_STORE_MODEM_TYPE = (RIL_REQUEST_MTK_BASE + 66);
    int RIL_REQUEST_QUERY_MODEM_TYPE = (RIL_REQUEST_MTK_BASE + 67);
    int RIL_REQUEST_SIM_INTERFACE_SWITCH = (RIL_REQUEST_MTK_BASE + 68);

    //MTK-START [mtk80776] WiFi Calling
    int RIL_REQUEST_UICC_SELECT_APPLICATION = (RIL_REQUEST_MTK_BASE + 69);
    int RIL_REQUEST_UICC_DEACTIVATE_APPLICATION = (RIL_REQUEST_MTK_BASE + 70);
    int RIL_REQUEST_UICC_APPLICATION_IO = (RIL_REQUEST_MTK_BASE + 71);
    int RIL_REQUEST_UICC_AKA_AUTHENTICATE = (RIL_REQUEST_MTK_BASE + 72);
    int RIL_REQUEST_UICC_GBA_AUTHENTICATE_BOOTSTRAP = (RIL_REQUEST_MTK_BASE + 73);
    int RIL_REQUEST_UICC_GBA_AUTHENTICATE_NAF = (RIL_REQUEST_MTK_BASE + 74);
    //MTK-END [mtk80776] WiFi Calling
    int RIL_REQUEST_STK_EVDL_CALL_BY_AP = (RIL_REQUEST_MTK_BASE + 75);

    // Femtocell (CSG)
    int RIL_REQUEST_GET_FEMTOCELL_LIST  = (RIL_REQUEST_MTK_BASE + 76);
    int RIL_REQUEST_ABORT_FEMTOCELL_LIST = (RIL_REQUEST_MTK_BASE + 77);
    int RIL_REQUEST_SELECT_FEMTOCELL = (RIL_REQUEST_MTK_BASE + 78);

    // For OPLMN update
    int RIL_REQUEST_SEND_OPLMN = (RIL_REQUEST_MTK_BASE + 79);
    int RIL_REQUEST_GET_OPLMN_VERSION = (RIL_REQUEST_MTK_BASE + 80);

    // For PLMN List abort
    int RIL_REQUEST_ABORT_QUERY_AVAILABLE_NETWORKS = (RIL_REQUEST_MTK_BASE + 81);
    // CSD
    int RIL_REQUEST_DIAL_UP_CSD = (RIL_REQUEST_MTK_BASE + 82);

    // M: For telephony modes update
    int RIL_REQUEST_SET_TELEPHONY_MODE = (RIL_REQUEST_MTK_BASE + 83);

    /// M: CC010: Add RIL interface @{
    int RIL_REQUEST_HANGUP_ALL = (RIL_REQUEST_MTK_BASE + 84);
    int RIL_REQUEST_FORCE_RELEASE_CALL = (RIL_REQUEST_MTK_BASE + 85);
    int RIL_REQUEST_SET_CALL_INDICATION = (RIL_REQUEST_MTK_BASE + 86);
    int RIL_REQUEST_EMERGENCY_DIAL = (RIL_REQUEST_MTK_BASE + 87);
    int RIL_REQUEST_SET_ECC_SERVICE_CATEGORY = (RIL_REQUEST_MTK_BASE + 88);
    int RIL_REQUEST_SET_ECC_LIST = (RIL_REQUEST_MTK_BASE + 89);
    /// @}

    //New SIM Authentication
    int RIL_REQUEST_GENERAL_SIM_AUTH = (RIL_REQUEST_MTK_BASE + 90);
    //ISIM
    int RIL_REQUEST_OPEN_ICC_APPLICATION = (RIL_REQUEST_MTK_BASE + 91);
    int RIL_REQUEST_GET_ICC_APPLICATION_STATUS = (RIL_REQUEST_MTK_BASE + 92);
    //SIM_IO_EX
    int RIL_REQUEST_SIM_IO_EX = (RIL_REQUEST_MTK_BASE + 93);

    // IMS
    int RIL_REQUEST_SET_IMS_ENABLE = (RIL_REQUEST_MTK_BASE + 94);
    int RIL_REQUEST_QUERY_AVAILABLE_NETWORKS_WITH_ACT = (RIL_REQUEST_MTK_BASE + 95);

    /* M: SS part */
    ///M: For query CNAP
    int RIL_REQUEST_SEND_CNAP = (RIL_REQUEST_MTK_BASE + 96);
    int RIL_REQUEST_SET_CLIP = (RIL_REQUEST_MTK_BASE + 97);
    /* M: SS part end */

    /** M: VoLTE data start */
    int RIL_REQUEST_SETUP_DEDICATE_DATA_CALL = (RIL_REQUEST_MTK_BASE + 98);
    int RIL_REQUEST_DEACTIVATE_DEDICATE_DATA_CALL = (RIL_REQUEST_MTK_BASE + 99);
    int RIL_REQUEST_MODIFY_DATA_CALL = (RIL_REQUEST_MTK_BASE + 100);
    int RIL_REQUEST_ABORT_SETUP_DATA_CALL = (RIL_REQUEST_MTK_BASE + 101);
    int RIL_REQUEST_PCSCF_DISCOVERY_PCO = (RIL_REQUEST_MTK_BASE + 102);
    int RIL_REQUEST_CLEAR_DATA_BEARER = (RIL_REQUEST_MTK_BASE + 103);
    /** M: VoLTE end */

    // MTK-START, SMS part, CB extension
    int RIL_REQUEST_REMOVE_CB_MESSAGE = (RIL_REQUEST_MTK_BASE + 104);
    // MTK-END, SMS part, CB extension

    // NAS configuration for voice call
    // 0: voice centric
    // 1: data centric
    int RIL_REQUEST_SET_DATA_CENTRIC = (RIL_REQUEST_MTK_BASE + 105);

    /// M: IMS feature. @{
    int RIL_REQUEST_ADD_IMS_CONFERENCE_CALL_MEMBER = (RIL_REQUEST_MTK_BASE + 106);
    int RIL_REQUEST_REMOVE_IMS_CONFERENCE_CALL_MEMBER = (RIL_REQUEST_MTK_BASE + 107);
    int RIL_REQUEST_DIAL_WITH_SIP_URI = (RIL_REQUEST_MTK_BASE + 108);
    int RIL_REQUEST_RESUME_CALL = (RIL_REQUEST_MTK_BASE + 109);
    /// @}

    /// M: CC010: Add RIL interface @{
    int RIL_REQUEST_SET_SPEECH_CODEC_INFO = (RIL_REQUEST_MTK_BASE + 110);
    /// @}
    /// M: CC33 LTE
    int RIL_REQUEST_SET_DATA_ON_TO_MD = (RIL_REQUEST_MTK_BASE + 111);
    int RIL_REQUEST_SET_REMOVE_RESTRICT_EUTRAN_MODE = (RIL_REQUEST_MTK_BASE + 112);

    /// M: CC010: Add RIL interface @{
    int RIL_REQUEST_SET_IMS_CALL_STATUS = (RIL_REQUEST_MTK_BASE + 113);
    /// @}

    /// M: For 3G VT only @{
    int RIL_REQUEST_VT_DIAL = (RIL_REQUEST_MTK_BASE + 114);
    int RIL_REQUEST_VOICE_ACCEPT = (RIL_REQUEST_MTK_BASE + 115);
    int RIL_REQUEST_REPLACE_VT_CALL = (RIL_REQUEST_MTK_BASE + 116);
    /// @}

    //C2K SVLTE remote SIM access
    int RIL_REQUEST_CONFIG_MODEM_STATUS = (RIL_REQUEST_MTK_BASE + 117);

    // M: [C2K] MD IRAT RIL requests.
    int RIL_REQUEST_SET_ACTIVE_PS_SLOT = RIL_REQUEST_MTK_BASE + 118;
    int RIL_REQUEST_CONFIRM_INTER_3GPP_IRAT_CHANGE = RIL_REQUEST_MTK_BASE + 119;

    /// M: [C2K][SVLTE] Set the SVLTE RAT mode. @{
    int RIL_REQUEST_SET_SVLTE_RAT_MODE = (RIL_REQUEST_MTK_BASE + 120);
    /// M: [C2K][SVLTE] Set the SVLTE RAT mode. @}

    // M: [C2K] AP IRAT RIL requests.
    int RIL_REQUEST_TRIGGER_LTE_BG_SEARCH = (RIL_REQUEST_MTK_BASE + 121);

    /// M: IMS VoLTe conference dial feature. @{
    int RIL_REQUEST_CONFERENCE_DIAL = (RIL_REQUEST_MTK_BASE + 122);
    /// @}

    /// M: CC072: Add Customer proprietary-IMS RIL interface. @{
    /* To transfer IMS call context to modem */
    int RIL_REQUEST_SET_SRVCC_CALL_CONTEXT_TRANSFER = (RIL_REQUEST_MTK_BASE + 123);
    /* To update IMS registration status to modem */
    int RIL_REQUEST_UPDATE_IMS_REGISTRATION_STATUS = (RIL_REQUEST_MTK_BASE + 124);
    /// @}

    int RIL_REQUEST_RELOAD_MODEM_TYPE = (RIL_REQUEST_MTK_BASE + 125);

    // @}
    // M:[C2K] deactivate link down PDN. @{
    int RIL_REQUEST_DEACTIVATE_LINK_DOWN_PDN = (RIL_REQUEST_MTK_BASE + 126);
    ///@}
    /// M: IMS feature. @{
    int RIL_REQUEST_HOLD_CALL = (RIL_REQUEST_MTK_BASE + 127);
    /// @}


    /// M: [C2K][SVLTE] Set the STK UTK mode. @{
    int RIL_REQUEST_SET_STK_UTK_MODE = (RIL_REQUEST_MTK_BASE + 128);
    /// M: [C2K][SVLTE] Set the STK UTK mode. @}

    int RIL_REQUEST_SWITCH_ANTENNA = (RIL_REQUEST_MTK_BASE + 129);
    ...
    int RIL_UNSOL_PHB_READY_NOTIFICATION = (RIL_UNSOL_MTK_BASE + 2);
    int RIL_UNSOL_SIM_INSERTED_STATUS = (RIL_UNSOL_MTK_BASE + 3);
    int RIL_UNSOL_RADIO_TEMPORARILY_UNAVAILABLE = (RIL_UNSOL_MTK_BASE + 4);
    int RIL_UNSOL_ME_SMS_STORAGE_FULL = (RIL_UNSOL_MTK_BASE + 5);
    int RIL_UNSOL_SMS_READY_NOTIFICATION = (RIL_UNSOL_MTK_BASE + 6);
    int RIL_UNSOL_SCRI_RESULT = (RIL_UNSOL_MTK_BASE + 7);
    int RIL_UNSOL_SIM_MISSING = (RIL_UNSOL_MTK_BASE + 8);
    int RIL_UNSOL_GPRS_DETACH = (RIL_UNSOL_MTK_BASE + 9);
    //MTK-START [mtk04070][120208][ALPS00233196] ATCI for unsolicited response
    int RIL_UNSOL_ATCI_RESPONSE = (RIL_UNSOL_MTK_BASE + 10);
    //MTK-END [mtk04070][120208][ALPS00233196] ATCI for unsolicited response
    int RIL_UNSOL_SIM_RECOVERY = (RIL_UNSOL_MTK_BASE + 11);
    int RIL_UNSOL_VIRTUAL_SIM_ON = (RIL_UNSOL_MTK_BASE + 12);
    int RIL_UNSOL_VIRTUAL_SIM_OFF = (RIL_UNSOL_MTK_BASE + 13);
    int RIL_UNSOL_INVALID_SIM = (RIL_UNSOL_MTK_BASE + 14);
    int RIL_UNSOL_RESPONSE_PS_NETWORK_STATE_CHANGED = (RIL_UNSOL_MTK_BASE + 15);
    int RIL_UNSOL_RESPONSE_ACMT = (RIL_UNSOL_MTK_BASE + 16);
    int RIL_UNSOL_EF_CSP_PLMN_MODE_BIT = (RIL_UNSOL_MTK_BASE + 17);
    int RIL_UNSOL_IMEI_LOCK = (RIL_UNSOL_MTK_BASE + 18);
    int RIL_UNSOL_RESPONSE_MMRR_STATUS_CHANGED = (RIL_UNSOL_MTK_BASE + 19);
    int RIL_UNSOL_SIM_PLUG_OUT = (RIL_UNSOL_MTK_BASE + 20);
    int RIL_UNSOL_SIM_PLUG_IN = (RIL_UNSOL_MTK_BASE + 21);
    int RIL_UNSOL_RESPONSE_ETWS_NOTIFICATION = (RIL_UNSOL_MTK_BASE + 22);
    int RIL_UNSOL_RESPONSE_PLMN_CHANGED = (RIL_UNSOL_MTK_BASE + 23);
    int RIL_UNSOL_RESPONSE_REGISTRATION_SUSPENDED = (RIL_UNSOL_MTK_BASE + 24);
    int RIL_UNSOL_STK_EVDL_CALL = (RIL_UNSOL_MTK_BASE + 25);
    int RIL_UNSOL_DATA_PACKETS_FLUSH = (RIL_UNSOL_MTK_BASE + 26);
    int RIL_UNSOL_FEMTOCELL_INFO = (RIL_UNSOL_MTK_BASE + 27);
    int RIL_UNSOL_STK_SETUP_MENU_RESET = (RIL_UNSOL_MTK_BASE + 28);
    int RIL_UNSOL_APPLICATION_SESSION_ID_CHANGED = (RIL_UNSOL_MTK_BASE + 29);
    /// M: For updating call ids for conference call after SRVCC is done.
    int RIL_UNSOL_ECONF_SRVCC_INDICATION = (RIL_UNSOL_MTK_BASE + 30);
    // IMS
    int RIL_UNSOL_IMS_ENABLE_DONE = (RIL_UNSOL_MTK_BASE + 31);
    int RIL_UNSOL_IMS_DISABLE_DONE = (RIL_UNSOL_MTK_BASE + 32);
    int RIL_UNSOL_IMS_REGISTRATION_INFO = (RIL_UNSOL_MTK_BASE + 33);
    //VoLTE
    int RIL_UNSOL_DEDICATE_BEARER_ACTIVATED = (RIL_UNSOL_MTK_BASE + 34);
    int RIL_UNSOL_DEDICATE_BEARER_MODIFIED = (RIL_UNSOL_MTK_BASE + 35);
    int RIL_UNSOL_DEDICATE_BEARER_DEACTIVATED = (RIL_UNSOL_MTK_BASE + 36);

    //sm cause rac
    int RIL_UNSOL_RAC_UPDATE = (RIL_UNSOL_MTK_BASE + 37);

    //[VoLTE]Conf. call merged/added result
    int RIL_UNSOL_ECONF_RESULT_INDICATION = (RIL_UNSOL_MTK_BASE + 38);

    //Remote SIM ME lock related APIs [Start]
    int RIL_UNSOL_MELOCK_NOTIFICATION = (RIL_UNSOL_MTK_BASE + 39);
    //Remote SIM ME lock related APIs [END]

    /// M: CC010: Add RIL interface @{
    int RIL_UNSOL_CALL_FORWARDING = (RIL_UNSOL_MTK_BASE + 40);
    int RIL_UNSOL_CRSS_NOTIFICATION = (RIL_UNSOL_MTK_BASE + 41);
    int RIL_UNSOL_INCOMING_CALL_INDICATION = (RIL_UNSOL_MTK_BASE + 42);
    int RIL_UNSOL_CIPHER_INDICATION = (RIL_UNSOL_MTK_BASE + 43);
    int RIL_UNSOL_CNAP = (RIL_UNSOL_MTK_BASE + 44);
    /// @}
    int RIL_UNSOL_SIM_COMMON_SLOT_NO_CHANGED = (RIL_UNSOL_MTK_BASE + 45);
    //Combine attach
    int RIL_UNSOL_DATA_ALLOWED = (RIL_UNSOL_MTK_BASE + 46);
    int RIL_UNSOL_STK_CALL_CTRL = (RIL_UNSOL_MTK_BASE + 47);
    int RIL_UNSOL_VOLTE_EPS_NETWORK_FEATURE_SUPPORT = (RIL_UNSOL_MTK_BASE + 48);

    /// M: IMS feature. @{
    int RIL_UNSOL_CALL_INFO_INDICATION = (RIL_UNSOL_MTK_BASE + 49);
    /// @}

    int RIL_UNSOL_VOLTE_EPS_NETWORK_FEATURE_INFO = (RIL_UNSOL_MTK_BASE + 50);
    int RIL_UNSOL_SRVCC_HANDOVER_INFO_INDICATION = (RIL_UNSOL_MTK_BASE + 51);
    /// M: CC010: Add RIL interface @{
    int RIL_UNSOL_SPEECH_CODEC_INFO = (RIL_UNSOL_MTK_BASE + 52);
    /// @}

    //MTK-START for MD state change
    int RIL_UNSOL_MD_STATE_CHANGE = (RIL_UNSOL_MTK_BASE + 53);
    //MTK-END for MD state change
    // M: CC33 URC
    int RIL_UNSOL_REMOVE_RESTRICT_EUTRAN = (RIL_UNSOL_MTK_BASE + 54);

    // IMS client on AP shall get the information of MO Data Barring and SSAC barring
    int RIL_UNSOL_MO_DATA_BARRING_INFO = (RIL_UNSOL_MTK_BASE + 55);
    int RIL_UNSOL_SSAC_BARRING_INFO = (RIL_UNSOL_MTK_BASE + 56);
    int RIL_UNSOL_SIP_CALL_PROGRESS_INDICATOR = (RIL_UNSOL_MTK_BASE + 57);

    int RIL_UNSOL_ABNORMAL_EVENT = (RIL_UNSOL_MTK_BASE + 58);

    /// M: CC071: Add Customer proprietary-IMS RIL interface . @{
    int RIL_UNSOL_EMERGENCY_BEARER_SUPPORT_NOTIFY = (RIL_UNSOL_MTK_BASE + 59);
    /// @}

    /// M: [C2K] MD IRAT RIL URCs.
    int RIL_UNSOL_INTER_3GPP_IRAT_STATE_CHANGE = RIL_UNSOL_MTK_BASE + 60;

    // M: [C2K] AP IRAT RIL URCs.
    int RIL_UNSOL_LTE_BG_SEARCH_STATUS = (RIL_UNSOL_MTK_BASE + 61);

    /// M: [C2K][IR][MD-IRAT] URC for GMSS RAT changed. @{
    int RIL_UNSOL_GMSS_RAT_CHANGED = (RIL_UNSOL_MTK_BASE + 62);
    /// M: [C2K][IR][MD-IRAT] URC for GMSS RAT changed. @}

    int RIL_UNSOL_CDMA_CARD_TYPE = (RIL_UNSOL_MTK_BASE + 63);

    // IMS
    int RIL_UNSOL_IMS_ENABLE_START = (RIL_UNSOL_MTK_BASE + 64);
    int RIL_UNSOL_IMS_DISABLE_START = (RIL_UNSOL_MTK_BASE + 65);
    int RIL_UNSOL_IMSI_REFRESH_DONE = (RIL_UNSOL_MTK_BASE + 66);
    // M: Notify RILJ that the AT+EUSIM was received
    int RIL_UNSOL_EUSIM_READY = (RIL_UNSOL_MTK_BASE + 67);

    /// M: For 3G VT only @{
    int RIL_UNSOL_VT_STATUS_INFO = (RIL_UNSOL_MTK_BASE + 68);
    int RIL_UNSOL_VT_RING_INFO = (RIL_UNSOL_MTK_BASE + 69);
    /// @}
