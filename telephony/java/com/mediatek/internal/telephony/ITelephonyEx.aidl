...
interface ITelephonyEx {
    ...
    String getSimCountryIso(int subId);

    String getSubscriberId(int subId);
    
    int getSimState(int simId);

    String getSimOperator(int subId);
    
    String getSimOperatorName(int subId);

    String getSimSerialNumber(int subId);

    String getLine1AlphaTag(int subId);

    String getVoiceMailNumber(int subId);

    String getVoiceMailAlphaTag(int subId);
  ...
  /**
   ...
   /**
     ...
     * @internal
    */
    void setImsEnable(int subId, boolean enable);
    ...
    */
     ...
     */
    String getScAddressUsingSubId(in int subId);
     ...
     */
    void setScAddressUsingSubId(in int subId, in String address);
     ...
     * @return void
     */
    void registerForImsDisableDone(int subId, IBinder binder, int what);
     ...
     * @return void
     */
    void unregisterForImsDisableDone(int subId, IBinder binder);
